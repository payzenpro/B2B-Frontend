...
// // src/components/CustomerCart.jsx
...
// //   const onQuantityChange = (cartId, qty) => {
// //     if (qty < 1) return;
...
// //                     min={1}
// //                     value={item.quantity}
// //                     onChange={(val) => onQuantityChange(item.cartId, val)}
// //                   />,
// //                   <Select
// //                     value={item.selectedSize}
// //                     onChange={(val) => updateSize(item.cartId, val)}
// //                   >
...
// //                     onChange={(val) => updateColor(item.cartId, val)}
// //                   >
// //                     {(item.colors || ["Black", "White"]).map((color) => (
